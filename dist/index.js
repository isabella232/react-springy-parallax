...
var _reactDomAnimated = require('react-dom-animated');

var _reactDomAnimated2 = _interopRequireDefault(_reactDomAnimated);
...
var _class = function (_React$Component) {
  ...
  _createClass(_class, [{
    ...
    value: function scrollTo(offset) {
      ...
      this.animatedScroll = new _reactDomAnimated2.default.Value(target.scrollTop);
...
_class.defaultProps = {
  effect: function effect(animation, toValue) {
    return _reactDomAnimated2.default.spring(animation, { toValue: toValue });
  },
  scrolling: true
};
...
_class.Layer = (_temp = _class2 = function (_React$Component2) {
  ...
  function _class2(props, context) {
    ...
    _this2.animatedTranslate = new _reactDomAnimated2.default.Value(toValue);
    var height = parallax.height * props.factor;
    _this2.animatedHeight = new _reactDomAnimated2.default.Value(height);
    return _this2;
  }
  ...
  _createClass(_class2, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactDomAnimated2.default.div,
        _extends({}, props, {
          ref: 'layer',
          className: className,
          style: _extends({
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onScroll = (0, _lodash2.default)(function (event) {
    if (!_this4.busy) {
      _this4.busy = true;
      _this4.scrollerRaf();
  ...
  this.updateRaf = (0, _lodash2.default)(function () {
